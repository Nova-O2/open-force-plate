...
"""
Force Plate MVP — Reinforcement Analysis
...
# Rev 1.0 and does not implement the composite transformed-section method.
# The analysis SSOT is docs/STRUCTURAL_ANALYSIS.md (§7 transformed section,
# recomputed by hand for Rev 3.1). Kept only as a historical record of the
# Rev 1.0 all-aluminum analysis — do NOT use its numbers for the current design.
